    ...
    public function index_get()
    {
        ...
        if ($id === NULL)
        {
            ...
            if ($Suppliers)
            {
                ...
                $this->response($Suppliers, \API\Libraries\REST_Controller::HTTP_OK); // OK (200) being the HTTP response code
            }
            else
            {
                // Set the response and exit
        ...
        // Find and return a single record for a particular Supplier.
        else {
            $id = (int) $id;
            ...
            if (!empty($Supplier))
            {
                $this->set_response($Supplier, \API\Libraries\REST_Controller::HTTP_OK); // OK (200) being the HTTP response code
            }
            else
            {
                $this->set_response([
